...
Verification is part of REVIEW rather than a separate role. IMPLEMENT submits affected-scope evidence for initial work and finding corrections; the reviewer independently reruns or extends risk-relevant checks. REVIEW handles both initial and finding review and may be authorized to L3. REVIEW-AND-FIX may review and correct to L3 but cannot finally approve its own L3 correction.
