...
Use `IMPLEMENT → REVIEW → FIX → RE-REVIEW → VERIFY`. Git checkpoints are optional review targets, not handoffs. After two materially different unsuccessful fixes, stop.
